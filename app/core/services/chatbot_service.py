...
class ChatbotService:
    ...
    def __init__(self, installation_id, provider=None):
        ...
        self.github_service = GithubService(installation_id=installation_id)
    ...
    def process_query(self, owner, repo, pr_number, sender, query):
        ...
        self.github_service.post_comment(owner, repo, pr_number, response)